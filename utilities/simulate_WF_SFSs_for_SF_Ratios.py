...
def parsecommandline():
    ...
    parser.add_argument("-a", dest="densityparams", type=float, nargs="+", required=True, help="One or more values, fixed2Ns:2Ns lognormal: mu sigma max2Ns  gamma: mean shape max2Ns normal: mu sigma ")
